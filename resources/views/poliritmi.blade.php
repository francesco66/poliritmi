...
<body>
    ...
    <div class="container mx-auto p-4">
        ...
        <h1 id="titolo" class="text-xl py-8">POLIRITMI</h1>
        ...
        <input hidden name="scorefilename" id="scorefilename" value="{{ $scorefilename }}">
        ...
        <form hidden name="savefiles" id="savefiles" method="post" action="{{ url('poliritmi') }}">
            ...
            <textarea name="scorefile" id="scorefile" value=""></textarea>
        ...
        <div class="flex flex-row gap-6">
            ...
            <div class="flex flex-col border border-black rounded-md p-4">
                ...
                <label class="label">
                    <span class="label-text">Divisors (min 2, max 18 ?)</span>
                </label>
                <label class="input-group pb-4">
...
<script>
    ...
    // var fileMei = document.getElementById("meifile");
</script>
